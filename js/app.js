...
const BOOKS_DATA = [
  ...
  { id:3,  title:"1984",                                    author:"George Orwell",        price:175,  originalPrice:229,  rating:4.8, reviews:6892,  category:"Science Fiction", badge:"Must Read",          coverClass:"cover-scifi",      emoji:"👁️", pages:328, publisher:"Signet Classic",        year:1961, description:"A haunting vision of a totalitarian future. Winston Smith's rebellion against Big Brother's all-seeing surveillance state remains one of literature's most powerful warnings.",                                                                             inStock:true,  featured:true,  newArrival:false },
  { id:4,  title:"Dune",                                    author:"Frank Herbert",        price:245,  originalPrice:329,  rating:4.7, reviews:4521,  category:"Science Fiction", badge:"Epic",               coverClass:"cover-scifi",      emoji:"🏜️", pages:688, publisher:"Chilton Books",         year:1965, description:"A sweeping saga of politics, religion, and ecology on the desert planet Arrakis — home to the universe's most precious resource. A landmark of science fiction.",                                                                                      inStock:true,  featured:true,  newArrival:false },
  { id:5,  title:"Atomic Habits",                           author:"James Clear",          price:279,  originalPrice:369,  rating:4.9, reviews:8734,  category:"Self-Help",       badge:"#1 Bestseller",      coverClass:"cover-selfhelp",   emoji:"⚡", pages:320, publisher:"Avery",                 year:2018, description:"A proven framework for building good habits and breaking bad ones. Tiny 1% improvements compound into remarkable results over time.",                                                                                                                    inStock:true,  featured:true,  newArrival:false },
  { id:6,  title:"Sapiens",                                 author:"Yuval Noah Harari",    price:265,  originalPrice:349,  rating:4.7, reviews:9102,  category:"Non-Fiction",     badge:"Global Bestseller",  coverClass:"cover-nonfiction", emoji:"🌍", pages:443, publisher:"Harper",                year:2015, description:"A bold exploration of humankind's history — from the Stone Age to the digital era — examining how Homo sapiens came to rule the world through biology, language, and power.",                                                                          inStock:true,  featured:true,  newArrival:false },
  ...
  { id:8,  title:"Gone Girl",                               author:"Gillian Flynn",        price:229,  originalPrice:null, rating:4.2, reviews:3456,  category:"Mystery",         badge:"Thriller",           coverClass:"cover-mystery",    emoji:"🔍", pages:422, publisher:"Crown",                 year:2012, description:"On their fifth anniversary, Nick Dunne reports his wife Amy missing. As investigation unfolds, a complex marriage unravels in alternating perspectives full of dark twists.",                                                                           inStock:true,  featured:true,  newArrival:false },
  { id:9,  title:"Becoming",                                author:"Michelle Obama",       price:259,  originalPrice:379,  rating:4.9, reviews:12089, category:"Biography",       badge:"NYT #1",             coverClass:"cover-biography",  emoji:"👑", pages:448, publisher:"Crown",                 year:2018, description:"An intimate and powerful memoir by the former First Lady — from her Chicago childhood to the White House years. A story of identity, resilience, and hope.",                                                                                          inStock:true,  featured:false, newArrival:true  },
  ...
  { id:12, title:"Pride and Prejudice",                     author:"Jane Austen",         price:159,  originalPrice:null, rating:4.7, reviews:6543,  category:"Romance",         badge:"Classic",            coverClass:"cover-romance",    emoji:"❤️", pages:432, publisher:"Penguin Classics",     year:2002, description:"Elizabeth Bennet navigates love, class, and self-discovery in Georgian England. Austen's wit and insight into human nature make this one of the most beloved novels ever written.",                                                                 inStock:true,  featured:false, newArrival:false },
  { id:13, title:"Guns, Germs, and Steel",                  author:"Jared Diamond",       price:249,  originalPrice:319,  rating:4.4, reviews:3201,  category:"History",         badge:"Pulitzer Prize",     coverClass:"cover-history",    emoji:"🏛️", pages:498, publisher:"W. W. Norton",         year:1997, description:"Diamond argues that geography and environment — not race — determined which civilisations flourished. A fascinating account of human societal development.",                                                                                       inStock:true,  featured:false, newArrival:false },
  ...
  { id:16, title:"How to Win Friends and Influence People",  author:"Dale Carnegie",      price:199,  originalPrice:259,  rating:4.5, reviews:7823,  category:"Self-Help",       badge:"All-Time Classic",   coverClass:"cover-selfhelp",   emoji:"🤝", pages:288, publisher:"Simon & Schuster",     year:1936, description:"Carnegie's timeless guide to building meaningful relationships, handling people effectively, and becoming a more likable and influential leader.",                                                                                                    inStock:true,  featured:false, newArrival:false },
  ...
  { id:18, title:"Me Before You",                            author:"Jojo Moyes",         price:199,  originalPrice:259,  rating:4.5, reviews:5432,  category:"Romance",         badge:"Heartfelt",          coverClass:"cover-romance",    emoji:"🌹", pages:369, publisher:"Pamela Dorman Books",  year:2012, description:"An unlikely relationship between Lou Clark and quadriplegic Will Traynor challenges both of their notions of what makes life worth living — a profoundly emotional story.",                                                                    inStock:true,  featured:false, newArrival:true  },
  { id:19, title:"Thinking, Fast and Slow",                  author:"Daniel Kahneman",    price:245,  originalPrice:339,  rating:4.5, reviews:4892,  category:"Non-Fiction",     badge:"Nobel Prize Winner", coverClass:"cover-nonfiction", emoji:"🧠", pages:499, publisher:"Farrar, Straus and Giroux", year:2011, description:"Nobel laureate Kahneman illuminates the two systems driving the way we think — fast intuitive System 1 and slow deliberate System 2 — revealing biases that shape our world.",                                                              inStock:true,  featured:false, newArrival:false },
  ...
  { id:21, title:"Brave New World",                          author:"Aldous Huxley",      price:175,  originalPrice:229,  rating:4.3, reviews:4567,  category:"Science Fiction", badge:"Dystopian",          coverClass:"cover-scifi",      emoji:"🧬", pages:311, publisher:"Harper Perennial",    year:1932, description:"A chilling vision of a future society where genetic engineering and conditioning create a seemingly perfect but profoundly dehumanised world.",                                                                                                  inStock:true,  featured:false, newArrival:false },
...
const USED_BOOKS_DATA = [
  { id:101, title:"The Great Gatsby",                     author:"F. Scott Fitzgerald", price:89,  originalPrice:189, condition:"Very Good",  conditionNote:"Minor shelf wear on cover, pages clean and unmarked.",               coverClass:"cover-fiction",    emoji:"✨", category:"Fiction",         rating:4.5, reviews:2847,  badge:"Used – Very Good", inStock:true },
  { id:102, title:"Sapiens",                              author:"Yuval Noah Harari",   price:129, originalPrice:265, condition:"Good",       conditionNote:"Some pencil underlining inside — great annotated reading copy.",      coverClass:"cover-nonfiction", emoji:"🌍", category:"Non-Fiction",     rating:4.7, reviews:9102,  badge:"Used – Good",      inStock:true },
  { id:103, title:"Atomic Habits",                        author:"James Clear",         price:149, originalPrice:279, condition:"Like New",   conditionNote:"Read once. Near-perfect condition, no markings whatsoever.",          coverClass:"cover-selfhelp",   emoji:"⚡", category:"Self-Help",       rating:4.9, reviews:8734,  badge:"Used – Like New",  inStock:true },
  { id:104, title:"Dune",                                 author:"Frank Herbert",       price:119, originalPrice:245, condition:"Good",       conditionNote:"Creased spine from reading, all pages clean and bright.",             coverClass:"cover-scifi",      emoji:"🏜️", category:"Science Fiction", rating:4.7, reviews:4521,  badge:"Used – Good",      inStock:true },
  { id:105, title:"Becoming",                             author:"Michelle Obama",      price:139, originalPrice:259, condition:"Like New",   conditionNote:"Excellent condition — looks completely unread.",                       coverClass:"cover-biography",  emoji:"👑", category:"Biography",       rating:4.9, reviews:12089, badge:"Used – Like New",  inStock:true },
  { id:106, title:"Gone Girl",                            author:"Gillian Flynn",       price:99,  originalPrice:229, condition:"Very Good",  conditionNote:"Light cover wear, all interior pages clean and crisp.",               coverClass:"cover-mystery",    emoji:"🔍", category:"Mystery",         rating:4.2, reviews:3456,  badge:"Used – Very Good", inStock:true },
  { id:107, title:"Pride and Prejudice",                  author:"Jane Austen",         price:79,  originalPrice:159, condition:"Good",       conditionNote:"Vintage Penguin copy. Well-loved, some yellowing typical of age.",    coverClass:"cover-romance",    emoji:"❤️", category:"Romance",         rating:4.7, reviews:6543,  badge:"Used – Good",      inStock:true },
  { id:108, title:"1984",                                 author:"George Orwell",       price:95,  originalPrice:175, condition:"Very Good",  conditionNote:"Minor scuff on back cover. Interior pages in perfect condition.",     coverClass:"cover-scifi",      emoji:"👁️", category:"Science Fiction", rating:4.8, reviews:6892,  badge:"Used – Very Good", inStock:true },
  { id:109, title:"Thinking, Fast and Slow",              author:"Daniel Kahneman",     price:125, originalPrice:245, condition:"Good",       conditionNote:"Highlighted passages throughout — ideal annotated study copy.",       coverClass:"cover-nonfiction", emoji:"🧠", category:"Non-Fiction",     rating:4.5, reviews:4892,  badge:"Used – Good",      inStock:true },
  { id:110, title:"The Hitchhiker's Guide to the Galaxy", author:"Douglas Adams",       price:89,  originalPrice:199, condition:"Like New",   conditionNote:"Minimal wear, tight spine. A beautiful copy in superb condition.",   coverClass:"cover-scifi",      emoji:"🚀", category:"Science Fiction", rating:4.6, reviews:4892,  badge:"Used – Like New",  inStock:true }
];
...
$(function () {
  ...
  $('#search-input').on('input', function () {
    ...
    $('#search-results').html(matches.map(b => {
      ...
      return `
        <a href="books.html" class="search-result-item flex items-center gap-3 p-3 rounded-xl hover:bg-white hover:bg-opacity-10 transition-colors cursor-pointer open-modal-btn" data-id="${b.id}" data-used="${isUsed}">
  ...
  // Add new book to cart (delegated)
  ...
  // Add used book to cart (delegated)
    ...
    <div class="flex flex-col md:flex-row gap-6 p-6">
      ...
      <div class="flex-1">
        ...
        <div class="flex items-center justify-between mt-5 flex-wrap gap-3">
          ...
          <button class="btn-add-cart add-used-to-cart-btn bg-amber-500 hover:bg-amber-600 text-white font-semibold px-6 py-2.5 rounded-xl flex items-center gap-2 text-sm" data-id="${book.id}">
            <i class="fas fa-cart-plus"></i> Add to Cart
          </button>
        </div>
      </div>
